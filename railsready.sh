...
ruby_version="2.2.1"
ruby_version_string="2.2.1"
ruby_source_url="http://cache.ruby-lang.org/pub/ruby/2.2/ruby-2.2.1.tar.gz"
ruby_source_tar_name="ruby-2.2.1.tar.gz"
ruby_source_dir_name="ruby-2.2.1"
